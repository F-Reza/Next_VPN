import 'package:next_vpn_lite/screens/locations/vip_server_screen.dart';
      ...
      () => DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor: Pref.isDarkMode?Color(0xFF2080ff):Color(0xFF1e1f24),
            elevation: 0,
            title: Text('VPN Locations (${_controller.vpnList.length})',
              style: TextStyle(color: Pref.isDarkMode?Colors.white:Colors.white54),),
